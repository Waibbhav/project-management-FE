...
@Component({
  selector: 'app-timeline-scheduler',
  templateUrl: './timeline-scheduler.component.html',
  styleUrls: ['./timeline-scheduler.component.scss']
})
export class TimelineSchedulerComponent implements OnInit {
  ...
  ngOnInit() {
    // this.chartLoaderService.loadGoogleCharts().subscribe(() => {
    //   this.drawChart();
    // });
